...
Using the Knowledge Mining service, we will create a complex index of documents that allows an analyst to perform an advanced search and explore the inter-document graph relationships (Lab 4).
...
Using the Conversational AI platform, we provide a conversational bot that helps analysts navigate the corpus of research documents and identify the most relevant ones (Lab 5).
...
The lab covers clustering with Azure Machine Learning, Automated ML, and model explainabity.
...
- Use the newly found clusters to label research document and run Auto ML process to train a clasiffier
...
### Lab 4 - [Knowledge Mining with Azure Cognitive Search and Form Recognition](04-knowledge-mining/README.md)

This lab covers Azure Cognitive Search (index, knowledge store, custom skills).
...
### Lab 5 - [Conversational AI with Azure Bot Service](05-conversational-ai/README.md)

The lab covers the Azure Bot Service (Bot Framework Composer and LUIS).
